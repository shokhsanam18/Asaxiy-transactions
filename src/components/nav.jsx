...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="NavBar sticky top-0 flex shadow-sm p-5 h-[90px] justify-between items-center flex-wrap flex-shrink">
      ...
      {side ? (
        <div className="SideBar h-screen w-[320px] fixed top-0 left-0 bg-neutral-100 flex p-5 gap-10 flex-col translate-x-0 transition-all">
          <div className="logo">
            <a href="/">
              <img src={Logo} alt="" />
            </a>
        ...
        <div className="SideBar h-screen w-[320px] fixed top-0 left-0 bg-neutral-100 flex p-5 gap-10 flex-col -translate-x-full transition-all">
          <div className="logo">
            <a href="/">
              <img src={Logo} alt="" />
            </a>
